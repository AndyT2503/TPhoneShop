...
{
    internal class GetBrandsForAdminQueryHandler(CommerceDbContext dbContext, IMediaService mediaService) : IRequestHandler<GetPublicBrandsQuery, PagingResponse<BrandDto>>
    {
